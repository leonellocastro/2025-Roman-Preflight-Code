...
if __name__ == "__main__":
    ...
    print(f"--> Simulating Independent Off-Axis Planet at {planet_x_offset} L/D...")
    ...
    # Coherent combination of two mathematically isolated numpy arrays
    combined_intensity = np.abs(field_star)**2 + np.abs(field_planet)**2
    
    # Normalization anchored to the peak of the raw pupil map
    ...
    plt.title(f"True Roman HLC Core Simulation (Isolated Planet Peak)", fontsize=14)
